...
public class TruffulaPrinterTest {
    ...
    @Test
    public void testPrintTree_ExactOutput_WithCustomPrintStream_default(@TempDir File tempDir) throws IOException {
        // Build the example directory structure:
        // myFolder/
        // .hidden.txt
        // Apple.txt
        ...
        // Set up TruffulaOptions with showHidden = false and useColor = flase
    ...
    @Test
    public void testPrintTree_ExactOutput_WithCustomPrintStream_ShowHiddenFalse(@TempDir File tempDir)
            throws IOException {
        // Build the example directory structure:
        // myFolder/
        // .hidden.txt
        ...
        // Create a hidden file in myFolder
        TruffulaOptions options = new TruffulaOptions(myFolder, false, false); // no hidden files, no colors
        // createHiddenFile(myFolder, ".hidden.txt");
        createHiddenFile(myFolder, ".hidden.txt");
    ...
    @Test
    public void testPrintTree_ExactOutput_WithCustomPrintStream_showHiddenTrue(@TempDir File tempDir)
            throws IOException {
        // Build the example directory structure:
        // myFolder/
        // .hidden.txt
        ...
        // Create a hidden file in myFolder
        TruffulaOptions options = new TruffulaOptions(myFolder, true, false); // no hidden files, no colors
        // createHiddenFile(myFolder, ".hidden.txt");
        createHiddenFile(myFolder, ".hidden.txt");
